...
################################################################
# This is a generated script based on design: zcu106vcu_base
#
...
# source zcu106vcu_base_script.tcl
...
if { $list_projs eq "" } {
   create_project zcu106vcu_base zcu106vcu_base -part xczu7ev-ffvc1156-2-e
...
set design_name zcu106vcu_base
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLKOUT4_REQUESTED_OUT_FREQ {33.3333} \
  ...
  # Create instance: interconnect_periphral, and set properties
  set interconnect_periphral [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect interconnect_periphral ]
  set_property -dict [ list \
   CONFIG.NUM_MI {1} \
 ] $interconnect_periphral

  # Create instance: interconnect_vcu_enc, and set properties
  set interconnect_vcu_enc [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect interconnect_vcu_enc ]
  set_property -dict [ list \
   CONFIG.M00_HAS_REGSLICE {4} \
   CONFIG.NUM_MI {1} \
   CONFIG.NUM_SI {2} \
 ...
 ] $interconnect_vcu_enc

  # Create instance: interconnect_vcu_dec, and set properties
  set interconnect_vcu_dec [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect interconnect_vcu_dec ]
  set_property -dict [ list \
   CONFIG.M00_HAS_REGSLICE {4} \
   CONFIG.NUM_MI {1} \
   CONFIG.NUM_SI {2} \
   CONFIG.S00_HAS_REGSLICE {4} \
   CONFIG.S01_HAS_REGSLICE {4} \
 ] $interconnect_vcu_dec

  # Create instance: interconnect_vcu_mcu, and set properties
  set interconnect_vcu_mcu [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect interconnect_vcu_mcu ]
  set_property -dict [ list \
   CONFIG.NUM_MI {1} \
 ] $interconnect_vcu_mcu
 ...
 set_property SELECTED_SIM_MODEL tlm [get_bd_cells /ps_e]
  ...
  connect_bd_intf_net -intf_net ps_e_M_AXI_HPM0_FPD [get_bd_intf_pins ps_e/M_AXI_HPM0_FPD] [get_bd_intf_pins interconnect_axihpm0fpd/S00_AXI]
  connect_bd_intf_net -intf_net ps_e_M_AXI_HPM1_FPD [get_bd_intf_pins ps_e/M_AXI_HPM1_FPD] [get_bd_intf_pins interconnect_periphral/S00_AXI]
  connect_bd_intf_net -intf_net ps_e_M_AXI_HPM0_LPD [get_bd_intf_pins ps_e/M_AXI_HPM0_LPD] [get_bd_intf_pins interconnect_axilite/S00_AXI]
  connect_bd_intf_net -intf_net interconnect_axihpm0fpd_M00_AXI [get_bd_intf_pins interconnect_axihpm0fpd/M00_AXI] [get_bd_intf_pins axi_register_slice_0/S_AXI]
  connect_bd_intf_net -intf_net interconnect_periphral_M01_AXI [get_bd_intf_pins interconnect_periphral/M00_AXI] [get_bd_intf_pins vcu_0/S_AXI_LITE]
  connect_bd_intf_net -intf_net interconnect_axilite_M00_AXI [get_bd_intf_pins interconnect_axilite/M00_AXI] [get_bd_intf_pins axi_intc_0/s_axi]
  connect_bd_intf_net -intf_net interconnect_axifull_M00_AXI [get_bd_intf_pins interconnect_axifull/M00_AXI] [get_bd_intf_pins ps_e/S_AXI_HP0_FPD]
  connect_bd_intf_net -intf_net interconnect_vcu_enc_M00_AXI1 [get_bd_intf_pins interconnect_vcu_enc/M00_AXI] [get_bd_intf_pins ps_e/S_AXI_HP2_FPD]
  connect_bd_intf_net -intf_net interconnect_vcu_dec_M00_AXI [get_bd_intf_pins interconnect_vcu_dec/M00_AXI] [get_bd_intf_pins ps_e/S_AXI_HP3_FPD]
  connect_bd_intf_net -intf_net interconnect_vcu_mcu_M00_AXI [get_bd_intf_pins interconnect_vcu_mcu/M00_AXI] [get_bd_intf_pins ps_e/S_AXI_HPC0_FPD]
  ...
  connect_bd_intf_net -intf_net vcu_0_M_AXI_DEC0 [get_bd_intf_pins vcu_0/M_AXI_DEC0] [get_bd_intf_pins interconnect_vcu_dec/S00_AXI]
  connect_bd_intf_net -intf_net vcu_0_M_AXI_DEC1 [get_bd_intf_pins vcu_0/M_AXI_DEC1] [get_bd_intf_pins interconnect_vcu_dec/S01_AXI]
  connect_bd_intf_net -intf_net vcu_0_M_AXI_ENC0 [get_bd_intf_pins vcu_0/M_AXI_ENC0] [get_bd_intf_pins interconnect_vcu_enc/S00_AXI]
  connect_bd_intf_net -intf_net vcu_0_M_AXI_ENC1 [get_bd_intf_pins vcu_0/M_AXI_ENC1] [get_bd_intf_pins interconnect_vcu_enc/S01_AXI]
  connect_bd_intf_net -intf_net vcu_0_M_AXI_MCU [get_bd_intf_pins vcu_0/M_AXI_MCU] [get_bd_intf_pins interconnect_vcu_mcu/S00_AXI]
  ...
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins interconnect_vcu_enc/ACLK] [get_bd_pins interconnect_vcu_enc/M00_ACLK] [get_bd_pins interconnect_vcu_enc/S00_ACLK] [get_bd_pins interconnect_vcu_enc/S01_ACLK] [get_bd_pins interconnect_vcu_dec/ACLK] [get_bd_pins interconnect_vcu_dec/M00_ACLK] [get_bd_pins interconnect_vcu_dec/S00_ACLK] [get_bd_pins interconnect_vcu_dec/S01_ACLK] [get_bd_pins interconnect_vcu_mcu/ACLK] [get_bd_pins interconnect_vcu_mcu/M00_ACLK] [get_bd_pins interconnect_vcu_mcu/S00_ACLK] [get_bd_pins axi_register_slice_0/aclk] [get_bd_pins axi_vip_0/aclk] [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins interconnect_axifull/ACLK] [get_bd_pins interconnect_axifull/M00_ACLK] [get_bd_pins interconnect_axifull/S00_ACLK] [get_bd_pins interconnect_axihpm0fpd/ACLK] [get_bd_pins interconnect_axihpm0fpd/M00_ACLK] [get_bd_pins interconnect_axihpm0fpd/S00_ACLK] [get_bd_pins proc_sys_reset_1/slowest_sync_clk] [get_bd_pins ps_e/maxihpm0_fpd_aclk] [get_bd_pins ps_e/saxihp0_fpd_aclk] [get_bd_pins ps_e/saxihp2_fpd_aclk] [get_bd_pins ps_e/saxihp3_fpd_aclk] [get_bd_pins ps_e/saxihpc0_fpd_aclk] [get_bd_pins vcu_0/m_axi_dec_aclk] [get_bd_pins vcu_0/m_axi_enc_aclk] [get_bd_pins vcu_0/m_axi_mcu_aclk]
  connect_bd_net -net clk_wiz_0_clk_out3 [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_out3] [get_bd_pins interconnect_periphral/ACLK] [get_bd_pins interconnect_periphral/M00_ACLK] [get_bd_pins interconnect_periphral/S00_ACLK] [get_bd_pins interconnect_axilite/ACLK] [get_bd_pins interconnect_axilite/M00_ACLK] [get_bd_pins interconnect_axilite/S00_ACLK] [get_bd_pins proc_sys_reset_2/slowest_sync_clk] [get_bd_pins ps_e/maxihpm0_lpd_aclk] [get_bd_pins vcu_0/s_axi_lite_aclk] [get_bd_pins ps_e/maxihpm1_fpd_aclk]
  connect_bd_net -net clk_wiz_0_clk_out4 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins proc_sys_reset_0/slowest_sync_clk]
  connect_bd_net -net clk_wiz_0_clk_out5 [get_bd_pins clk_wiz_0/clk_out4] [get_bd_pins proc_sys_reset_3/slowest_sync_clk] [get_bd_pins vcu_0/pll_ref_clk]
  ...
  connect_bd_net -net proc_sys_reset_1_interconnect_aresetn [get_bd_pins interconnect_vcu_enc/ARESETN] [get_bd_pins interconnect_vcu_enc/M00_ARESETN] [get_bd_pins interconnect_vcu_enc/S00_ARESETN] [get_bd_pins interconnect_vcu_enc/S01_ARESETN] [get_bd_pins interconnect_vcu_dec/ARESETN] [get_bd_pins interconnect_vcu_dec/M00_ARESETN] [get_bd_pins interconnect_vcu_dec/S00_ARESETN] [get_bd_pins interconnect_vcu_dec/S01_ARESETN] [get_bd_pins interconnect_vcu_mcu/ARESETN] [get_bd_pins interconnect_vcu_mcu/M00_ARESETN] [get_bd_pins interconnect_vcu_mcu/S00_ARESETN] [get_bd_pins interconnect_axifull/ARESETN] [get_bd_pins interconnect_axifull/M00_ARESETN] [get_bd_pins interconnect_axifull/S00_ARESETN] [get_bd_pins interconnect_axihpm0fpd/ARESETN] [get_bd_pins interconnect_axihpm0fpd/M00_ARESETN] [get_bd_pins interconnect_axihpm0fpd/S00_ARESETN] [get_bd_pins proc_sys_reset_1/interconnect_aresetn]
  ...
  connect_bd_net -net proc_sys_reset_2_interconnect_aresetn [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins interconnect_periphral/ARESETN] [get_bd_pins interconnect_periphral/M00_ARESETN] [get_bd_pins interconnect_periphral/S00_ARESETN]  [get_bd_pins interconnect_axilite/ARESETN] [get_bd_pins interconnect_axilite/M00_ARESETN] [get_bd_pins interconnect_axilite/S00_ARESETN] [get_bd_pins proc_sys_reset_2/interconnect_aresetn]
  connect_bd_net -net ps_e_emio_gpio_o [get_bd_pins ps_e/emio_gpio_o] [get_bd_pins xlslice_0/Din]
  connect_bd_net -net ps_e_pl_clk0 [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins ps_e/pl_clk0]
  connect_bd_net -net vcu_0_vcu_host_interrupt [get_bd_pins vcu_0/vcu_host_interrupt] [get_bd_pins xlconcat_0/In7]
  ...
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces axi_vip_0/Master_AXI] [get_bd_addr_segs ps_e/SAXIGP2/HP0_DDR_LOW] -force
  ...
  assign_bd_address -offset 0xB0000000 -range 0x00100000 -target_address_space [get_bd_addr_spaces ps_e/Data] [get_bd_addr_segs vcu_0/S_AXI_LITE/Reg] -force
  ...
  set_property PFM_NAME {xilinx.com:zcu106:zcu106vcu_base:1.0} [get_files [current_bd_design].bd]
  ...
  set_property PFM.AXI_PORT {M_AXI_HPM0_FPD {memport "M_AXI_GP"}  S_AXI_HP0_FPD {memport "S_AXI_HP" sptag "HP0" memory "ps_e HP0_DDR_LOW"} } [get_bd_cells /ps_e]
...
generate_target  all  [get_files  ./zcu106vcu_base/zcu106vcu_base.srcs/sources_1/bd/zcu106vcu_base/zcu106vcu_base.bd]
set_property generate_synth_checkpoint true [get_files -norecurse *.bd]
make_wrapper -files [get_files ./zcu106vcu_base/zcu106vcu_base.srcs/sources_1/bd/zcu106vcu_base/zcu106vcu_base.bd] -top
add_files -norecurse ./zcu106vcu_base/zcu106vcu_base.srcs/sources_1/bd/zcu106vcu_base/hdl/zcu106vcu_base_wrapper.v
...
file mkdir ./zcu106vcu_base/zcu106vcu_base.sdk
write_hwdef -force  -file ./zcu106vcu_base/zcu106vcu_base.sdk/zcu106vcu_base_wrapper.hdf
#file copy -force ./zcu106vcu_base/zcu106vcu_base.runs/impl_1/zcu106_wrapper.sysdef ./zcu106vcu_base/zcu106vcu_base.sdk/zcu106_wrapper.hdf

set_property platform.post_sys_link_tcl_hook ./dynamic_postlink.tcl [current_project]

#write_hw_platform -unified -include_bit ./zcu106vcu_base.xsa
write_hw_platform -force ./zcu106vcu_base.xsa
validate_hw_platform ./zcu106vcu_base.xsa
