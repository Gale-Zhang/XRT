platform -name zcu106vcu_base -desc "A reVISION platform targeting the ZCU106 evaluation board, which includes 2GB of DDR4 for the Processing System, video codec unit supports H.264/H.265, optimized to work with reVISION development environment. More information at https://www.xilinx.com/products/boards-and-kits/zcu106.html" -hw ./zcu106vcu_base.xsa -out ./output
